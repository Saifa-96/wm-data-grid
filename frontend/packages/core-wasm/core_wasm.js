...
export class Cell {
    ...
    */
    get height() {
        const ret = wasm.__wbg_get_cell_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set height(arg0) {
        wasm.__wbg_set_cell_height(this.__wbg_ptr, arg0);
    }
}

const CellPropertyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cellproperty_free(ptr >>> 0, 1));
/**
*/
export class CellProperty {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CellPropertyFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_cellproperty_free(ptr, 0);
    }
}
...
export class DataGrid {
    ...
    */
    get_cells() {
        const ret = wasm.datagrid_get_cells(this.__wbg_ptr);
    ...
    */
    move_selected_cell(direction) {
        wasm.datagrid_move_selected_cell(this.__wbg_ptr, direction);
    }
    /**
    * @returns {any}
    */
